...
urlpatterns = [
    ...
    path("znak/export/", views.ChecklistDateExportView.as_view(), name="checklist_date_export"),
    ...
    path("markem/export/", views.MarkemDateExportView.as_view(), name="markem_date_export"),
